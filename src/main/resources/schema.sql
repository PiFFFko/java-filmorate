...
(
	GENRE_ID   INTEGER GENERATED BY DEFAULT AS IGENTITY PRIMARY KEY,
...
(
    LIKE_ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRINARU KEY,
...
create TABLE IF NOT EXISTS  FILMS_GENRES (
    ...
    CONSTRAINT FILMS_GENRES_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS ON delete CASCADE,
    CONSTRAINT FILMS_GENRES_FK_1 FOREIGN KEY (GENRE_ID) REFERENCES GENRES ON delete CASCADE
);